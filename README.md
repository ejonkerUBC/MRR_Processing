...
The code will find the resonances in the scpectrum, fit them each of them with a lorentzian, and extract the relevant resonace data. 

Then, optionally futher calculations can be done such as FSR, group index, etc..
